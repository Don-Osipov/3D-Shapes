...
def generate_sphere(points, cx, cy, cz, r, step):
    ...
    for i in range(int(1 / step)):
        for j in range(int(1 / step)):
            phi, theta = i * step, j * step
            x = r * math.cos(pi * theta) + cx
            y = r * math.sin(pi * theta) * math.cos(2 * pi * phi) + cy
            z = r * math.sin(pi * theta) * math.sin(2 * pi * phi) + cz
...
def generate_torus(points, cx, cy, cz, r0, r1, step):
    ...
    for i in range(int(1 / step)):
        for j in range(int(1 / step)):
            phi, theta = i * step, j * step
            x = math.cos(2 * pi * phi) * (r0 * math.cos(2 * pi * theta) + r1) + cx
            y = r0 * math.sin(2 * pi * theta) + cy
            z = -math.sin(2 * pi * phi) * (r0 * math.cos(2 * pi * theta) + r1) + cz
